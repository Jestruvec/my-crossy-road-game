 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var jg;function XS(){return jg||(jg=1,function(s){function e(P,Q){var B=P.length;P.push(Q);t:for(;0<B;){var ct=B-1>>>1,w=P[ct];if(0<l(w,Q))P[ct]=Q,P[B]=w,B=ct;else break t}}function i(P){return P.length===0?null:P[0]}function r(P){if(P.length===0)return null;var Q=P[0],B=P.pop();if(B!==Q){P[0]=B;t:for(var ct=0,w=P.length,W=w>>>1;ct<W;){var ot=2*(ct+1)-1,gt=P[ot],Y=ot+1,ft=P[Y];if(0>l(gt,B))Y<w&&0>l(ft,gt)?(P[ct]=ft,P[Y]=B,ct=Y):(P[ct]=gt,P[ot]=B,ct=ot);else if(Y<w&&0>l(ft,B))P[ct]=ft,P[Y]=B,ct=Y;else break t}}return Q}function l(P,Q){var B=P.sortIndex-Q.sortIndex;return B!==0?B:P.id-Q.id}if(s.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var u=performance;s.unstable_now=function(){return u.now()}}else{var h=Date,d=h.now();s.unstable_now=function(){return h.now()-d}}var p=[],m=[],g=1,_=null,v=3,y=!1,E=!1,R=!1,M=!1,S=typeof setTimeout=="function"?setTimeout:null,z=typeof clearTimeout=="function"?clearTimeout:null,N=typeof setImmediate<"u"?setImmediate:null;function U(P){for(var Q=i(m);Q!==null;){if(Q.callback===null)r(m);else if(Q.startTime<=P)r(m),Q.sortIndex=Q.expirationTime,e(p,Q);else break;Q=i(m)}}function V(P){if(R=!1,U(P),!E)if(i(p)!==null)E=!0,k||(k=!0,lt());else{var Q=i(m);Q!==null&&dt(V,Q.startTime-P)}}var k=!1,F=-1,K=5,D=-1;function C(){return M?!0:!(s.unstable_now()-D<K)}function G(){if(M=!1,k){var P=s.unstable_now();D=P;var Q=!0;try{t:{E=!1,R&&(R=!1,z(F),F=-1),y=!0;var B=v;try{e:{for(U(P),_=i(p);_!==null&&!(_.expirationTime>P&&C());){var ct=_.callback;if(typeof ct=="function"){_.callback=null,v=_.priorityLevel;var w=ct(_.expirationTime<=P);if(P=s.unstable_now(),typeof w=="function"){_.callback=w,U(P),Q=!0;break e}_===i(p)&&r(p),U(P)}else r(p);_=i(p)}if(_!==null)Q=!0;else{var W=i(m);W!==null&&dt(V,W.startTime-P),Q=!1}}break t}finally{_=null,v=B,y=!1}Q=void 0}}finally{Q?lt():k=!1}}}var lt;if(typeof N=="function")lt=function(){N(G)};else if(typeof MessageChannel<"u"){var st=new MessageChannel,St=st.port2;st.port1.onmessage=G,lt=function(){St.postMessage(null)}}else lt=function(){S(G,0)};function dt(P,Q){F=S(function(){P(s.unstable_now())},Q)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(P){P.callback=null},s.unstable_forceFrameRate=function(P){0>P||125<P?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):K=0<P?Math.floor(1e3/P):5},s.unstable_getCurrentPriorityLevel=function(){return v},s.unstable_next=function(P){switch(v){case 1:case 2:case 3:var Q=3;break;default:Q=v}var B=v;v=Q;try{return P()}finally{v=B}},s.unstable_requestPaint=function(){M=!0},s.unstable_runWithPriority=function(P,Q){switch(P){case 1:case 2:case 3:case 4:case 5:break;default:P=3}var B=v;v=P;try{return Q()}finally{v=B}},s.unstable_scheduleCallback=function(P,Q,B){var ct=s.unstable_now();switch(typeof B=="object"&&B!==null?(B=B.delay,B=typeof B=="number"&&0<B?ct+B:ct):B=ct,P){case 1:var w=-1;break;case 2:w=250;break;case 5:w=1073741823;break;case 4:w=1e4;break;default:w=5e3}return w=B+w,P={id:g++,callback:Q,priorityLevel:P,startTime:B,expirationTime:w,sortIndex:-1},B>ct?(P.sortIndex=B,e(m,P),i(p)===null&&P===i(m)&&(R?(z(F),F=-1):R=!0,dt(V,B-ct))):(P.sortIndex=w,e(p,P),E||y||(E=!0,k||(k=!0,lt()))),P},s.unstable_shouldYield=C,s.unstable_wrapCallback=function(P){var Q=v;return function(){var B=v;v=Q;try{return P.apply(this,arguments)}finally{v=B}}}}(Vf)),Vf}var Kg;function WS(){return Kg||(Kg=1,Gf.exports=XS()),Gf.exports}var kf={exports:{}},re={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Qg;function qS(){if(Qg)return re;Qg=1;var s=Symbol.for("react.transitional.element"),e=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),u=Symbol.for("react.consumer"),h=Symbol.for("react.context"),d=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),m=Symbol.for("react.memo"),g=Symbol.for("react.lazy"),_=Symbol.iterator;function v(w){return w===null||typeof w!="object"?null:(w=_&&w[_]||w["@@iterator"],typeof w=="function"?w:null)}var y={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},E=Object.assign,R={};function M(w,W,ot){this.props=w,this.context=W,this.refs=R,this.updater=ot||y}M.prototype.isReactComponent={},M.prototype.setState=function(w,W){if(typeof w!="object"&&typeof w!="function"&&w!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,w,W,"setState")},M.prototype.forceUpdate=function(w){this.updater.enqueueForceUpdate(this,w,"forceUpdate")};function S(){}S.prototype=M.prototype;function z(w,W,ot){this.props=w,this.context=W,this.refs=R,this.updater=ot||y}var N=z.prototype=new S;N.constructor=z,E(N,M.prototype),N.isPureReactComponent=!0;var U=Array.isArray,V={H:null,A:null,T:null,S:null,V:null},k=Object.prototype.hasOwnProperty;function F(w,W,ot,gt,Y,ft){return ot=ft.ref,{$$typeof:s,type:w,key:W,ref:ot!==void 0?ot:null,props:ft}}function K(w,W){return F(w.type,W,void 0,void 0,void 0,w.props)}function D(w){return typeof w=="object"&&w!==null&&w.$$typeof===s}function C(w){var W={"=":"=0",":":"=2"};return"$"+w.replace(/[=:]/g,function(ot){return W[ot]})}var G=/\/+/g;function lt(w,W){return typeof w=="object"&&w!==null&&w.key!=null?C(""+w.key):W.toString(36)}function st(){}function St(w){switch(w.status){case"fulfilled":return w.value;case"rejected":throw w.reason;default:switch(typeof w.status=="string"?w.then(st,st):(w.status="pending",w.then(function(W){w.status==="pending"&&(w.status="fulfilled",w.value=W)},function(W){w.status==="pending"&&(w.status="rejected",w.reason=W)})),w.status){case"fulfilled":return w.value;case"rejected":throw w.reason}}throw w}function dt(w,W,ot,gt,Y){var ft=typeof w;(ft==="undefined"||ft==="boolean")&&(w=null);var xt=!1;if(w===null)xt=!0;else switch(ft){case"bigint":case"string":case"number":xt=!0;break;case"object":switch(w.$$typeof){case s:case e:xt=!0;break;case g:return xt=w._init,dt(xt(w._payload),W,ot,gt,Y)}}if(xt)return Y=Y(w),xt=gt===""?"."+lt(w,0):gt,U(Y)?(ot="",xt!=null&&(ot=xt.replace(G,"$&/")+"/"),dt(Y,W,ot,"",function(ae){return ae})):Y!=null&&(D(Y)&&(Y=K(Y,ot+(Y.key==null||w&&w.key===Y.key?"":(""+Y.key).replace(G,"$&/")+"/")+xt)),W.push(Y)),1;xt=0;var bt=gt===""?".":gt+":";if(U(w))for(var Ct=0;Ct<w.length;Ct++)gt=w[Ct],ft=bt+lt(gt,Ct),xt+=dt(gt,W,ot,ft,Y);else if(Ct=v(w),typeof Ct=="function")for(w=Ct.call(w),Ct=0;!(gt=w.next()).done;)gt=gt.value,ft=bt+lt(gt,Ct++),xt+=dt(gt,W,ot,ft,Y);else if(ft==="object"){if(typeof w.then=="function")return dt(St(w),W,ot,gt,Y);throw W=String(w),Error("Objects are not valid as a React child (found: "+(W==="[object Object]"?"object with keys {"+Object.keys(w).join(", ")+"}":W)+"). If you meant to render a collection of children, use an array instead.")}return xt}function P(w,W,ot){if(w==null)return w;var gt=[],Y=0;return dt(w,gt,"","",function(ft){return W.call(ot,ft,Y++)}),gt}function Q(w){if(w._status===-1){var W=w._result;W=W(),W.then(function(ot){(w._status===0||w._status===-1)&&(w._status=1,w._result=ot)},function(ot){(w._status===0||w._status===-1)&&(w._status=2,w._result=ot)}),w._status===-1&&(w._status=0,w._result=W)}if(w._status===1)return w._result.default;throw w._result}var B=typeof reportError=="function"?reportError:function(w){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var W=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof w=="object"&&w!==null&&typeof w.message=="string"?String(w.message):String(w),error:w});if(!window.dispatchEvent(W))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",w);return}console.error(w)};function ct(){}return re.Children={map:P,forEach:function(w,W,ot){P(w,function(){W.apply(this,arguments)},ot)},count:function(w){var W=0;return P(w,function(){W++}),W},toArray:function(w){return P(w,function(W){return W})||[]},only:function(w){if(!D(w))throw Error("React.Children.only expected to receive a single React element child.");return w}},re.Component=M,re.Fragment=i,re.Profiler=l,re.PureComponent=z,re.StrictMode=r,re.Suspense=p,re.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=V,re.__COMPILER_RUNTIME={__proto__:null,c:function(w){return V.H.useMemoCache(w)}},re.cache=function(w){return function(){return w.apply(null,arguments)}},re.cloneElement=function(w,W,ot){if(w==null)throw Error("The argument must be a React element, but you passed "+w+".");var gt=E({},w.props),Y=w.key,ft=void 0;if(W!=null)for(xt in W.ref!==void 0&&(ft=void 0),W.key!==void 0&&(Y=""+W.key),W)!k.call(W,xt)||xt==="key"||xt==="__self"||xt==="__source"||xt==="ref"&&W.ref===void 0||(gt[xt]=W[xt]);var xt=arguments.length-2;if(xt===1)gt.children=ot;else if(1<xt){for(var bt=Array(xt),Ct=0;Ct<xt;Ct++)bt[Ct]=arguments[Ct+2];gt.children=bt}return F(w.type,Y,void 0,void 0,ft,gt)},re.createContext=function(w){return w={$$typeof:h,_currentValue:w,_currentValue2:w,_threadCount:0,Provider:null,Consumer:null},w.Provider=w,w.Consumer={$$typeof:u,_context:w},w},re.createElement=function(w,W,ot){var gt,Y={},ft=null;if(W!=null)for(gt in W.key!==void 0&&(ft=""+W.key),W)k.call(W,gt)&&gt!=="key"&&gt!=="__self"&&gt!=="__source"&&(Y[gt]=W[gt]);var xt=arguments.length-2;if(xt===1)Y.children=ot;else if(1<xt){for(var bt=Array(xt),Ct=0;Ct<xt;Ct++)bt[Ct]=arguments[Ct+2];Y.children=bt}if(w&&w.defaultProps)for(gt in xt=w.defaultProps,xt)Y[gt]===void 0&&(Y[gt]=xt[gt]);return F(w,ft,void 0,void 0,null,Y)},re.createRef=function(){return{current:null}},re.forwardRef=function(w){return{$$typeof:d,render:w}},re.isValidElement=D,re.lazy=function(w){return{$$typeof:g,_payload:{_status:-1,_result:w},_init:Q}},re.memo=function(w,W){return{$$typeof:m,type:w,compare:W===void 0?null:W}},re.startTransition=function(w){var W=V.T,ot={};V.T=ot;try{var gt=w(),Y=V.S;Y!==null&&Y(ot,gt),typeof gt=="object"&&gt!==null&&typeof gt.then=="function"&&gt.then(ct,B)}catch(ft){B(ft)}finally{V.T=W}},re.unstable_useCacheRefresh=function(){return V.H.useCacheRefresh()},re.use=function(w){return V.H.use(w)},re.useActionState=function(w,W,ot){return V.H.useActionState(w,W,ot)},re.useCallback=function(w,W){return V.H.useCallback(w,W)},re.useContext=function(w){return V.H.useContext(w)},re.useDebugValue=function(){},re.useDeferredValue=function(w,W){return V.H.useDeferredValue(w,W)},re.useEffect=function(w,W,ot){var gt=V.H;if(typeof ot=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return gt.useEffect(w,W)},re.useId=function(){return V.H.useId()},re.useImperativeHandle=function(w,W,ot){return V.H.useImperativeHandle(w,W,ot)},re.useInsertionEffect=function(w,W){return V.H.useInsertionEffect(w,W)},re.useLayoutEffect=function(w,W){return V.H.useLayoutEffect(w,W)},re.useMemo=function(w,W){return V.H.useMemo(w,W)},re.useOptimistic=function(w,W){return V.H.useOptimistic(w,W)},re.useReducer=function(w,W,ot){return V.H.useReducer(w,W,ot)},re.useRef=function(w){return V.H.useRef(w)},re.useState=function(w){return V.H.useState(w)},re.useSyncExternalStore=function(w,W,ot){return V.H.useSyncExternalStore(w,W,ot)},re.useTransition=function(){return V.H.useTransition()},re.version="19.1.0",re}var Jg;function sd(){return Jg||(Jg=1,kf.exports=qS()),kf.exports}var Xf={exports:{}},Rn={};/**
 * @license React
...
`)+`
`+S);const N=z+M+h,U=z+S+d,V=Y_(l,l.VERTEX_SHADER,N),k=Y_(l,l.FRAGMENT_SHADER,U);l.attachShader(R,V),l.attachShader(R,k),i.index0AttributeName!==void 0?l.bindAttribLocation(R,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(R,0,"position"),l.linkProgram(R);function F(G){if(s.debug.checkShaderErrors){const lt=l.getProgramInfoLog(R).trim(),st=l.getShaderInfoLog(V).trim(),St=l.getShaderInfoLog(k).trim();let dt=!0,P=!0;if(l.getProgramParameter(R,l.LINK_STATUS)===!1)if(dt=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(l,R,V,k);else{const Q=j_(l,V,"vertex"),B=j_(l,k,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(R,l.VALIDATE_STATUS)+`
